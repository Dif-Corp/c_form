...
import 'package:c_form/c_form/core/c_form_constant.dart';
import 'package:c_form/c_form/core/c_form_field_call_back.dart';
import 'package:c_form/c_form/models/c_form_email_model.dart';

class CFormEmailField extends StatelessWidget implements CFormFieldCallBack {
  final CFormEmailModel model;
  final CFormStyle formStyle;

  final TextEditingController? controller = TextEditingController();

  CFormEmailField(this.model, this.formStyle, {Key? key}) : super(key: key);
  ...
  bool isValid() {
    if (model.validateRegEx == null) {
      if (controller!.text.isNotEmpty) {
        return RegExp(CFormConstant.emailRegEx).hasMatch(controller!.text);
      }
