...
class CFormCheckListField extends StatefulWidget implements CFormFieldCallBack {
  final CFormCheckBoxModel model;
  final CFormStyle? formStyle;

  CFormCheckListField(this.model, this.formStyle, {Key? key}) : super(key: key);

  List<CheckDataModel> valueObject = [];
  List<int> selectedItems = [];

  @override
  State<CFormCheckListField> createState() => _CFormCheckListFieldState();
...
class _CFormCheckListFieldState extends State<CFormCheckListField> {
...
class CheckBoxItem extends StatelessWidget {
  ...
  final CFormStyle formStyle;
  final CFormCheckBoxModel _model;
