...
class CFormMobileField extends StatelessWidget implements CFormFieldCallBack {
  final CFormMobileModel model;
  final CFormStyle formStyle;

  final TextEditingController? controller = TextEditingController();

  CFormMobileField(this.model, this.formStyle, {Key? key}) : super(key: key);
