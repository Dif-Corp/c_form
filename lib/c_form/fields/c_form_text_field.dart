...
class CFormTextField extends StatelessWidget implements CFormFieldCallBack {
  final CFormTextModel model;
  final CFormStyle formStyle;

  final TextEditingController? controller = TextEditingController();

  CFormTextField(this.model, this.formStyle, {Key? key}) : super(key: key);
