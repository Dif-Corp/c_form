...
class CFormRadioGroupField extends StatefulWidget
    implements CFormFieldCallBack {
  final CFormRadioModel model;
  final CFormStyle? formStyle;

  CFormRadioGroupField(this.model, this.formStyle, {Key? key})
      : super(key: key);

  RadioDataModel? returnedData;

  @override
  State<CFormRadioGroupField> createState() => _CFormRadioGroupFieldState();
...
class _CFormRadioGroupFieldState extends State<CFormRadioGroupField> {
