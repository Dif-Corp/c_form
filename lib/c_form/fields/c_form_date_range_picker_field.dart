...
class CFormDateRangePickerField extends StatefulWidget
    implements CFormFieldCallBack {
  final CFormDateRangePickerModel model;
  ...
  CFormDateRangePickerField(this.model, this.formStyle, {Key? key})
      : super(key: key);

  @override
  State<CFormDateRangePickerField> createState() =>
      _CFormDateRangePickerFieldState();
    ...
    if (model.calendarType == CFormCalendarType.jalali) {
      return (selectedEndDate == null && selectedStartDate == null)
          ...
          : DateDataRangeModel(
              ...
              startTimeStamp:
                  selectedStartDate!.toDateTime().millisecondsSinceEpoch,
              endTimeStamp:
                  selectedEndDate!.toDateTime().millisecondsSinceEpoch,
...
class _CFormDateRangePickerFieldState extends State<CFormDateRangePickerField> {
  @override
  void initState() {
    _initialDates();
    super.initState();
  ...
  _initialJalaliDates() {
    if (widget.model.initialStartDate == null) {
      ...
      widget.jalaliInitialStartDate = Jalali(
          widget.model.initialStartDate!.year,
          widget.model.initialStartDate!.month,
          widget.model.initialStartDate!.day);
    ...
    if (widget.model.initialEndDate == null) {
      ...
      widget.jalaliInitialEndDate = Jalali(widget.model.initialEndDate!.year,
          widget.model.initialEndDate!.month, widget.model.initialEndDate!.day);
